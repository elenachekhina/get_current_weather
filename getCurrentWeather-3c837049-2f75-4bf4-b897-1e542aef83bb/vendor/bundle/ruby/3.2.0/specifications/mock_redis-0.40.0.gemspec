# -*- encoding: utf-8 -*-
# stub: mock_redis 0.40.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/sds/mock_redis/issues", "changelog_uri" => "https://github.com/sds/mock_redis/blob/v0.40.0/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/mock_redis/0.40.0", "homepage_uri" => "https://github.com/sds/mock_redis", "source_code_uri" => "https://github.com/sds/mock_redis/tree/v0.40.0" } if s.respond_to? :metadata=
  ...
  s.add_development_dependency(%q<redis>.freeze, ["~> 4.8.0"])
